...
public class AlunoController {
	...
	public String getPorNomeContato(@RequestParam("nome") String nome, ModelMap model) {
		...
		return "/aluno/listaContatosPesquisa";
	}
	...
	@PostMapping("/editar")
	public String editar(Aluno aluno, ModelMap model, @AuthenticationPrincipal User user) {
	 ...
	 * id, ModelMap model) { model.addAttribute("aluno",
	 * alunoService.buscarPorId(id));
	 * 
	 * return "/aluno/cadastro"; }
	 * 
	 * @PostMapping("/editar") public String editar(Aluno aluno, RedirectAttributes
	 * attr) { alunoService.editar(aluno); attr.addFlashAttribute("success","Aluno
	 * Editado com sucesso."); return "redirect:/alunos/cadastrar"; }
	 **/
