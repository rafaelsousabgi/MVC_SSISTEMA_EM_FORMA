...
public interface ExercicioRepository extends JpaRepository<Exercicio, Long> {
	...
	/**
	 * 
	 * @Query("SELECT e FROM Exercicio e JOIN e.fichaTreinos ft JOIN ft.aluno a
	 * WHERE a.usuario.email LIKE :email") List<Exercicio>
	 * findByExercicioByAlunoEmail(String email);
	 * 
	 * 
	 * @Query("SELECT e FROM Exercicio e JOIN e.fichaTreinos ft JOIN
	 * ft.avaliacaoFisica af where af.instrutor.usuario.email LIKE :email")
...
/**
	@Query("SELECT e FROM Exercicio e WHERE e.fichaTreinos.aluno.nome LIKE %:nomeAluno%")
    List<Exercicio> buscarExerciciosPorNomeAluno(@Param("nomeAluno") String nomeAluno);**/

	/**
	 * @Query("SELECT e FROM Exercicio e JOIN e.fichaTreinos ft JOIN ft.aluno a
	 * WHERE a.nomel LIKE :nome") Page<Exercicio> findByExercicioByAlunoNome(String
